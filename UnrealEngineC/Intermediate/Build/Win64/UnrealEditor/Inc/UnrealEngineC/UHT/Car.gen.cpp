...
#include "UnrealEngineC/Car.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeCar() {}

// Begin Cross Module References
UNREALENGINEC_API UClass* Z_Construct_UClass_ACar();
UNREALENGINEC_API UClass* Z_Construct_UClass_ACar_NoRegister();
UNREALENGINEC_API UClass* Z_Construct_UClass_AVehicle();
UNREALENGINEC_API UClass* Z_Construct_UClass_AVehicle_NoRegister();
UNREALENGINEC_API UEnum* Z_Construct_UEnum_UnrealEngineC_ECarBrand();
...
static UEnum* ECarBrand_StaticEnum()
{
	...
	{
		Z_Registration_Info_UEnum_ECarBrand.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_UnrealEngineC_ECarBrand, (UObject*)Z_Construct_UPackage__Script_UnrealEngineC(), TEXT("ECarBrand"));
	}
...
struct Z_Construct_UEnum_UnrealEngineC_ECarBrand_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_UnrealEngineC_ECarBrand_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_UnrealEngineC,
	nullptr,
	"ECarBrand",
	"ECarBrand",
	Z_Construct_UEnum_UnrealEngineC_ECarBrand_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_UnrealEngineC_ECarBrand_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_UnrealEngineC_ECarBrand_Statics::Enum_MetaDataParams), Z_Construct_UEnum_UnrealEngineC_ECarBrand_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_UnrealEngineC_ECarBrand()
{
	if (!Z_Registration_Info_UEnum_ECarBrand.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ECarBrand.InnerSingleton, Z_Construct_UEnum_UnrealEngineC_ECarBrand_Statics::EnumParams);
	}
...
template<> UNREALENGINEC_API UClass* StaticClass<ACar>()
{
	return ACar::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_isabe_OneDrive_Computadora_Documentos_UNREAL_UnrealEngineCArden2025_UnrealEngineC_Source_UnrealEngineC_Car_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ ECarBrand_StaticEnum, TEXT("ECarBrand"), &Z_Registration_Info_UEnum_ECarBrand, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 126327837U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ACar, ACar::StaticClass, TEXT("ACar"), &Z_Registration_Info_UClass_ACar, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACar), 444519468U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_isabe_OneDrive_Computadora_Documentos_UNREAL_UnrealEngineCArden2025_UnrealEngineC_Source_UnrealEngineC_Car_h_3967386107(TEXT("/Script/UnrealEngineC"),
	Z_CompiledInDeferFile_FID_Users_isabe_OneDrive_Computadora_Documentos_UNREAL_UnrealEngineCArden2025_UnrealEngineC_Source_UnrealEngineC_Car_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_isabe_OneDrive_Computadora_Documentos_UNREAL_UnrealEngineCArden2025_UnrealEngineC_Source_UnrealEngineC_Car_h_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Users_isabe_OneDrive_Computadora_Documentos_UNREAL_UnrealEngineCArden2025_UnrealEngineC_Source_UnrealEngineC_Car_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_isabe_OneDrive_Computadora_Documentos_UNREAL_UnrealEngineCArden2025_UnrealEngineC_Source_UnrealEngineC_Car_h_Statics::EnumInfo));
// End Registration
